...
export default function Applications() {
    ...
    async function handleCreateApp(event: React.FormEvent<HTMLFormElement>) {
        ...
        const duplicate = apps.find(
            (app) =>
                app.identifier.trim().toLowerCase() ===
    ...
    async function handleDeleteApplication(appId: string) {
        if (
            !window.confirm(
                "Delete this application rule? This cannot be undone.",
            )
        ) {
            return;
        }
    ...
    function getAssignmentStats(appId: string): AssignmentStats {
        ...
        const allowScopes = appScopes.filter(
            (scope) => scope.action === "allow",
        );
        const blockScopes = appScopes.filter(
    ...
    return (
        <div className="grid equal-split">
            <div className="card">
                ...
                <p>
                    Define application rules using Santa-compatible identifiers.
                    Rules can then be assigned to groups or users from the
            ...
            <div className="card">
                ...
                <p>
                    Use <code>santactl fileinfo /path/to/app</code> to get these
                    values:
                </p>
                ...
                <div className="field-reference-guide">
                    <div className="santa-output-example-compact">
                        ...
                        <div className="santa-output-section">
                            <span className="santa-section-title">
                                Signing Chain:
                            </span>
            ...
            <div className="card" style={{ gridColumn: "1 / -1" }}>
                ...
                <p>
                    Manage who can access each application. Click an application
                    to open the full detail view with assignment controls.
                </p>
                ...
                {apps.length === 0 ? (
                    <div className="empty-state">
                        ...
                        <p>
                            Create your first application rule above to get
                            started.
                        </p>
                    </div>
                    ...
                    <div className="empty-state">
                        ...
                        <p style={{ margin: 0 }}>
                            ...
                            &quot;{appSearch}&quot;. Try a different search or
                            clear the filter.
                        </p>
                    </div>
                ) : (
