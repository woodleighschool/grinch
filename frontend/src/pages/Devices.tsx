...
export default function Devices() {
    ...
    return (
        <div className="card">
            <h2>Devices</h2>
            <p>
                Monitor and manage Santa agents deployed across your
                organization's devices.
            </p>

            <div className="stat-bubble-row">
                <div className="stat-bubble success">
                    <span className="stat-bubble-value">
                        {statusCounts.online}
                    </span>
                ...
                <div className="empty-state">
                    {searchTerm ? (
                        <>
                            ...
                            <p>
                                No devices match the search term "{searchTerm}"
                            </p>
                        </>
                    ) : (
                        <>
