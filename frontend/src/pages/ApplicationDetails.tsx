    ...
    return (
        <div className="assignment-form-target">
                                    ...
                                    activeItems.map((item) => (
                                        ...
                                        >
                                            <div className="target-selector-item-name">
                                                {activeTab === "groups"
                                                    ? (item as DirectoryGroup)
                                                        .display_name
                                                    : (item as DirectoryUser)
                                                        .display_name ||
                                                    (item as DirectoryUser)
                                                        .principal_name}
                                            </div>
            ...
            {!selectedTarget && (
                ...
                >
                    Choose whether to apply this rule to a group or an
                    individual user.
                </p>
            )}
        </div>
...
export default function ApplicationDetails() {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            try {
                ...
                const matchedApp =
                    allApps.find((item) => item.id === appId) ?? null;
    ...
    const handleDeleteScope = async (scopeId: string) => {
        ...
        try {
            ...
            setScopes((current) =>
                current.filter((scope) => scope.id !== scopeId),
            );
        } catch (err) {
            alert(
                err instanceof Error
            ...
            <div style={{ marginBottom: "24px" }}>
                ...
                >
                    <div>
                        ...
                        >
                            Manage assignments, view current scopes, and adjust
                ...
                <div className="assignment-groups">
                    ...
                    {allowScopes.length === 0 && blockScopes.length === 0 && (
                        ...
                        >
                            ...
                            <p>
                                Use the controls above to assign this
                                application to groups or individual users.
                            </p>
                        </div>
                    )}
                </div>
