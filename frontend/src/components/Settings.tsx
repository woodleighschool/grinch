...
const defaultSAMLSettings: SAMLSettings = {
  ...
  sp_certificate: '',
  name_id_format: '',
  object_id_attribute: 'http://schemas.microsoft.com/identity/claims/objectidentifier',
...
function SAMLSettingsModule({ settings, onSettingsChange, onSave, onReset, saving }: SAMLSettingsModuleProps) {

  const handleInputChange = (field: keyof SAMLSettings, value: string | boolean) => {
    onSettingsChange({
      ...settings,
      [field]: value
    });
  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); onSave(); }}>
      <div className="settings-form-content">
        ...
        <div className="grid two-column settings-form-section">
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange('sp_private_key', e.target.value)}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange('sp_certificate', e.target.value)}
        ...
        <div className="settings-form-section">
          <h4 className="settings-section-header">Advanced SAML Attributes</h4>
          <div className="settings-advanced-content">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('name_id_format', e.target.value)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('object_id_attribute', e.target.value)}
              />
            </div>
            <div>
              <label htmlFor="upn_attribute">
                UPN Attribute
              </label>
              <input
                id="upn_attribute"
                ...
                onChange={(e) => handleInputChange('upn_attribute', e.target.value)}
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('email_attribute', e.target.value)}
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('display_name_attribute', e.target.value)}
              />
            </div>
          </div>
        </div>
